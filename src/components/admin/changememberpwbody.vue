<template>
 ...
 <form  @submit.prevent="confirmchange">
  <div class="form-group row">
    <label for="inputEmail3" class="col-sm-4 col-form-label" v-model="user">User ID</label>
    <div class="col-sm-8">
      <input type="text" class="form-control" id="inputEmail3" placeholder="User ID" v-model="user">
    </div>
  </div>
  <div class="form-group row">
