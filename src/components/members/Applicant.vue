...
<hr />
      ...
      <b-button  variant="success"   v-on:click="confirmApplicant(applicant.id, applicant.phone, applicant.email, applicant.firstname, applicant.lastname)" >Confirm</b-button>
